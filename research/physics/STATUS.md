...
*Last updated: July 20, 2026 (evening session: exp-086/087/088 findings added — two-stage RG flow, structural vs semantic heads, N^0.435 scaling law; exp-089 pre-registered — Huginn latent-iteration RG flow)*
...
| Does recurrence depth in depth-recurrent models (Huginn) operationalize conformal depth at inference time? | Us — exp-089 | **Pre-registered 2026-07-20. Download in progress.** Hypothesis: Δ_med decreases toward 0.25 as recurrence count increases. Tests whether the conformal fixed point is an attractor for iterative processing in general, or specific to feedforward training. |
