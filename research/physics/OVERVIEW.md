...
**Level-3 status as of August 31:** Protocol identified; MLP block 0 is the dominant source of the position-correlated delta under the census protocol. The quantitative closure σ_delta_total ≈ 0.249 is reproduced. The mechanistic explanation of MLP0's σ = 0.313 is the remaining open question.
